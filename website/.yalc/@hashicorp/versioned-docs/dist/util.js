...
exports.normalizeRef = exports.logIf = exports.getVersionFromPath = exports.makeVersionedPath = exports.isInternalUrl = exports.PRODUCT_DOMAIN_MAP = void 0;
...
function normalizeRef(ref) {
    return ref.startsWith('refs/') ? ref.split('/').slice(2).join('/') : ref;
}
