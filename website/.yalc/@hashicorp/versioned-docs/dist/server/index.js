...
exports.getVersionFromPath = exports.loadVersionedDocument = exports.loadVersionedNavData = exports.loadVersionMetadata = exports.loadVersionList = exports.makeServeStaticAssets = void 0;
...
async function loadVersionList(product) {
    const versionsMetadata = await loadVersionMetadata(product);
    if (!versionsMetadata)
        return [];
...
async function loadVersionMetadata(product) {
    return ((await db_1.retrieveDocument(product, 'versionMetadata')) ?? {
        product,
        fullPath: 'versionMetadata',
        versions: [],
    });
}
exports.loadVersionMetadata = loadVersionMetadata;
// TODO: implement
